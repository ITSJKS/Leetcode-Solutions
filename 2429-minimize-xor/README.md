<h2><a href="https://leetcode.com/problems/minimize-xor/">2429. Minimize XOR</a></h2><h3>Medium</h3><hr><div><p>Given two positive integers <code>num1</code> and <code>num2</code>, find the integer <code>x</code> such that:</p>
...
<pre style="position: relative;"><strong>Input:</strong> num1 = 3, num2 = 5
...
<pre style="position: relative;"><strong>Input:</strong> num1 = 1, num2 = 12
<strong>Output:</strong> 3
<strong>Explanation:</strong>
