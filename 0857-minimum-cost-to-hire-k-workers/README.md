...
<pre style="position: relative;"><strong>Input:</strong> quality = [10,20,5], wage = [70,50,30], k = 2
...
<pre style="position: relative;"><strong>Input:</strong> quality = [3,1,10,10,1], wage = [4,8,2,2,7], k = 3
