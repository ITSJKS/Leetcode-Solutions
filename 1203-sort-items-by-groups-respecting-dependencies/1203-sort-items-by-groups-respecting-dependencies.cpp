// we can create a dependecy graph based on group and before items 
// we can keep a single group as one single node and apply their dependecy in the before items
// stupid logic
// 
class Solution {
public:
