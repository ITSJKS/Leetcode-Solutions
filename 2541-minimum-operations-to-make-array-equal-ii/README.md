...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [4,3,1,4], nums2 = [1,3,7,1], k = 3
...
One can prove that it is impossible to make arrays equal in fewer operations.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> nums1 = [3,8,5,2], nums2 = [2,4,1,6], k = 1
